...
public class ComentaryServiceImpl implements CommentaryService {
    ...
    @Override
    public List<Place> listComments(ListCommentsDTO listCommensDTO) throws ListCommentsExeception, GetClientException {
        ...
        for (Comentary c : comentaries){
            GetClientDTO getClientDTO = clientService.getClient(String.valueOf(c.getClient()));
        }
